 ...
 */
{
    class Details {
        constructor() {
            ...
            <button class="zacrug details__close"><svg class="icon icon--close"><use xlink:href="#icon-close"></use></svg></button>
        ...
        open(data) {
            ...
            const mobwin = (window.innerWidth > 640)? 1: 0.4;
            ...
            this.DOM.img.style.opacity = mobwin;
    ...
    const DOM = {};
    DOM.grid = document.querySelector('.work__last');
    DOM.content = DOM.grid.parentNode;
    DOM.hamburger = document.querySelector('.dummy-menu');
    DOM.gridItems = Array.from(DOM.grid.querySelectorAll('div.section__gallery-item'));
    let items = [];
